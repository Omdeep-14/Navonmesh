  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start" style={{ position: "relative" }}>
      ...
      <div className="glass-card" style={{
        ...
        {/* Tabs */}
        <div className="flex p-1 mb-6 rounded-xl" style={{
          background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)",
          width: "100%", boxSizing: "border-box",
        }}>
          <button className="glass-tab glass-tab-active" style={{ flex: 1, minWidth: 0 }}>Login</button>
          <button className="glass-tab glass-tab-inactive" onClick={() => onNavigate("signup")} style={{ flex: 1, minWidth: 0 }}>
            Sign Up
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-1" style={{ width: "100%" }}>
            <button type="submit" disabled={loading} className="mendi-btn mendi-btn-amber mendi-btn-block" style={{ justifyContent: "center", width: "100%", boxSizing: "border-box" }}>
